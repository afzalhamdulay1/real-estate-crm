      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        <div className="xl:col-span-2 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             ...
             <div className="glass-card p-10 h-[400px] flex flex-col relative group/velocity overflow-hidden">
             ...
             <div className="glass-card p-10 h-[400px] flex flex-col relative group/inv overflow-hidden">
